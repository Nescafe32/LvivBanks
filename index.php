        ...
        <div id="menu">
            <ul id="nav">
                ...
                <div class="registration">
                    <li><a href="#registration-popup">Registration</a></li>
                </div>
            </ul>
        </div>
    </div>
...
<div id="login-popup">
    ...
    <section id="login">
        <div class="sb"><a href="#" class="entypo-cancel close-top"><span
                        class="login-tip right">Close window</span></a></div>
        <div class="login-form">
            <div class="title">User login</div>
            <p class="intro"><b>Welcome!</b> Please, enter required data below</p>
            <form action="redirect.php" name="login" id="form-login" method="post">
                <div class="field">
                    <input name="username" placeholder="Username" type="text" id="username_login" required/> <span
                            class="entypo-user icon"></span> <span class="login-tip left">Enter your username</span>
                </div>
                <div class="field">
                    <input name="password" placeholder="Password" type="password" id="password_login" required/> <span
                            class="entypo-lock icon"></span> <span class="login-tip left">Enter your password</span>
                </div>
                <div>
                    <input type="checkbox" id="signed-in" name="signed-in" checked="checked"/>
                    <label for="signed-in" class="tick"><span>Keep me signed in</span></label>
                </div>
                <input type="submit" value="Login" class="send" name="trylogin"/></form>
        </div>
    </section>
</div>
<div id="registration-popup">
    ...
    <section id="registration">
        <div class="sb"><a href="#" class="entypo-cancel close-top"><span
                        class="registration-tip right">Close window</span></a></div>
        <div class="register-form">
            <div class="title">Registration</div>
            <p class="intro"><b>Welcome!</b> Please, enter required data below</p>
            <form action="redirect.php" name="register" id="form-registration" method="post">
                <div class="field">
                    <input name="firstname" placeholder="Firstname" type="text" id="firstname" required/> <span
                            class="entypo-user icon"></span> <span
                            class="registration-tip left">Choose your firstname</span></div>
                <div class="field">
                    <input name="lastname" placeholder="Lastname" type="text" id="lastname" required/> <span
                            class="entypo-user icon"></span> <span
                            class="registration-tip left">Choose your lastname</span></div>
                <div class="field">
                    <input name="username" placeholder="Username" type="text" id="username_registration" required/>
                    <span class="entypo-user icon"></span> <span
                            class="registration-tip left">Choose your username</span></div>
                <div class="field">
                    <input name="email" placeholder="Email" type="email" id="email" required/> <span
                            class="entypo-mail icon"></span> <span class="registration-tip left">Enter your email</span>
                </div>
                <div class="field">
                    <input name="password" placeholder="Password" type="password" id="password_registration" required/>
                    <span class="entypo-lock icon"></span> <span
                            class="registration-tip left">Enter your password</span></div>
                <div class="field">
                    <input name="passwordrepeat" placeholder="Password repeat" type="password" id="password-repeat"
                           required/> <span class="entypo-lock icon"></span> <span class="registration-tip left">Repeat your password</span>
                </div>
                <div>
                    <input type="checkbox" id="terms-agree" name="terms-agree" checked="checked"/>
                    <label for="terms-agree" class="tick"><span>I agree with <a
                                    href="#">Terms &amp; Conditions</a></span></label>
                </div>
                <input type="submit" value="Register" class="send" name="tryregister"/></form>
        </div>
    </section>
</div>
